...
function SetDataBind(Type) {
    ...
    $.ajax({
        type: "POST",
        url: '/Deployment/GetVehicleDeployedSummary',
        dataType: "json",
...
function ClickForRedirection(objthis) {
    ...
    var url = "/Deployment/VehicleDepNotDepSummary?vtypeid=" + vtypeid + "&zid=" + zid + "&Typeid=" + Typeid + "&cirid=" + cirid + "&wardid=" + wardid + "&stypeid=" + stypeid + "&SDate=" + SDate;
...
function bindtable(data) {
        ...
        for (j = 0; j < Zonedata[i].Circlelst.length; j++) {
            ...
            for (k = 0; k < Zonedata[i].Circlelst[j].Wardlst.length; k++) {
                ...
                for (l = 0; l < Zonedata[i].Circlelst[j].Wardlst[k].VehicleData.length; l++) {
                    ...
                    //    "</td>" +
                    //    "<td onclick='ClickForRedirection(this);' style='border: 1px solid black; text-align: center;' Typeid='" + 0 + "'  vtypeid='" + Zonedata[i].Circlelst[j].Wardlst[k].VehicleData[l].VehicleTypeId + "' zid='" + Zonedata[i].ZId + "' cirid='" + Zonedata[i].Circlelst[j].CircleId + "' wardid='" + Zonedata[i].Circlelst[j].Wardlst[k].WardId + "' stypeid='3'>" + totalVehicle +
                    //    "</td>" +
                    //    "<td onclick='ClickForRedirection(this);' style='border: 1px solid black; text-align: center;' Typeid='" + 0 + "'  vtypeid='" + Zonedata[i].Circlelst[j].Wardlst[k].VehicleData[l].VehicleTypeId + "' zid='" + Zonedata[i].ZId + "' cirid='" + Zonedata[i].Circlelst[j].CircleId + "' wardid='" + Zonedata[i].Circlelst[j].Wardlst[k].WardId + "' stypeid='1'>" + Zonedata[i].Circlelst[j].Wardlst[k].VehicleData[l].Deployed +
                    //    "</td>" +
                    //    "<td onclick='ClickForRedirection(this);' style='border: 1px solid black; text-align: center;' Typeid='" + 0 + "'  vtypeid='" + Zonedata[i].Circlelst[j].Wardlst[k].VehicleData[l].VehicleTypeId + "' zid='" + Zonedata[i].ZId + "' cirid='" + Zonedata[i].Circlelst[j].CircleId + "' wardid='" + Zonedata[i].Circlelst[j].Wardlst[k].WardId + "' stypeid='2'>" + Zonedata[i].Circlelst[j].Wardlst[k].VehicleData[l].NotDeployed +
                    //    "</td>" +
                    //    "<td  style='border: 1px solid black; text-align: center;' Typeid='" + 0 + "'  vtypeid='" + Zonedata[i].Circlelst[j].Wardlst[k].VehicleData[l].VehicleTypeId + "' zid='" + Zonedata[i].ZId + "' cirid='" + Zonedata[i].Circlelst[j].CircleId + "' wardid='" + Zonedata[i].Circlelst[j].Wardlst[k].WardId + "' stypeid='8'>" + Zonedata[i].Circlelst[j].Wardlst[k].VehicleData[l].DepPercentage +
                    ...
                    if (Zonedata[i].Circlelst[j].Wardlst[k].VehicleData[l].VehicleType == 0) {
                        ...
                        rows += "<td onclick='ClickForRedirection(this);'  style='border: 1px solid black; text-align: center;' Typeid='1' vtypeid='" + Zonedata[i].Circlelst[j].Wardlst[k].VehicleData[l].VehicleTypeId + "' zid='" + Zonedata[i].ZId + "' cirid='" + Zonedata[i].Circlelst[j].CircleId + "' wardid='" + Zonedata[i].Circlelst[j].Wardlst[k].WardId + "' stypeid='3'>" + totalVehicle + "</td>";
                        ...
                        rows += "<td  onclick='ClickForRedirection(this);'  style='border: 1px solid black; text-align: center;' Typeid='1' vtypeid='" + Zonedata[i].Circlelst[j].Wardlst[k].VehicleData[l].VehicleTypeId + "' zid='" + Zonedata[i].ZId + "' cirid='" + Zonedata[i].Circlelst[j].CircleId + "' wardid='" + Zonedata[i].Circlelst[j].Wardlst[k].WardId + "' stypeid='2'>" + Zonedata[i].Circlelst[j].Wardlst[k].VehicleData[l].NotDeployed + "</td>";

                        rows += "<td style='border: 1px solid black; text-align: center;' Typeid='1' vtypeid='" + Zonedata[i].Circlelst[j].Wardlst[k].VehicleData[l].VehicleTypeId + "' zid='" + Zonedata[i].ZId + "' cirid='" + Zonedata[i].Circlelst[j].CircleId + "' wardid='" + Zonedata[i].Circlelst[j].Wardlst[k].WardId + "' stypeid='8'>" + Zonedata[i].Circlelst[j].Wardlst[k].VehicleData[l].DepPercentage + " %" + "</td>";
                        ...
                        GTotalVehicle = GTotalVehicle + totalVehicle;
                        ...
                        rows += "<td style='border: 1px solid black; text - align: center;'>" + Zonedata[i].Circlelst[j].Wardlst[k].VehicleData[l].VehicleType + "</td>";
                        rows += "<td style='border: 1px solid black; text-align: center;'><a href='' onclick='ClickForRedirection(this);' Typeid='0' vtypeid='" + Zonedata[i].Circlelst[j].Wardlst[k].VehicleData[l].VehicleTypeId + "' zid='" + Zonedata[i].ZId + "' cirid='" + Zonedata[i].Circlelst[j].CircleId + "' wardid='" + Zonedata[i].Circlelst[j].Wardlst[k].WardId + "' stypeid='3'>" + totalVehicle + "</a></td>";
                        ...
                        rows += "<td style='border: 1px solid black; text-align: center;'><a href='' onclick='ClickForRedirection(this);' Typeid='0' vtypeid='" + Zonedata[i].Circlelst[j].Wardlst[k].VehicleData[l].VehicleTypeId + "' zid='" + Zonedata[i].ZId + "' cirid='" + Zonedata[i].Circlelst[j].CircleId + "' wardid='" + Zonedata[i].Circlelst[j].Wardlst[k].WardId + "' stypeid='2'>" + Zonedata[i].Circlelst[j].Wardlst[k].VehicleData[l].NotDeployed + "</a></td>";

                        rows += "<td style='border: 1px solid black; text-align: center;'><a href='' onclick='ClickForRedirection(this);' Typeid='0' vtypeid='" + Zonedata[i].Circlelst[j].Wardlst[k].VehicleData[l].VehicleTypeId + "' zid='" + Zonedata[i].ZId + "' cirid='" + Zonedata[i].Circlelst[j].CircleId + "' wardid='" + Zonedata[i].Circlelst[j].Wardlst[k].WardId + "' stypeid='8'>" + Zonedata[i].Circlelst[j].Wardlst[k].VehicleData[l].DepPercentage + " %" + "</a></td>";
    ...
    var footerRow = '<tfoot>' +
        ...
        '<td style="border: 1px solid black; text-align:center;">' + GTotalVehicle + '</td>' +
        ...
        '<td style="border: 1px solid black; text-align:center;">' + deppercentage.toFixed(2) + " %" + '</td>' +
        '</tr>' +
        '</tfoot>';
...
//            $(api.column(4).footer()).html(GTotalVehicle);
//            $(api.column(5).footer()).html(GDeployedVehicle);
...
function DownloadFile(FType) {
    ...
    $.ajax({
        type: "POST",
        url: "/Deployment/ExportAllVehicleDepNotDepSummary",
