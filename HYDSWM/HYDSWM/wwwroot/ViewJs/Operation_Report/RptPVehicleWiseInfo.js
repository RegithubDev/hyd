...
function GetDataTableData(Type) {
    ...
    dt = $('#example').DataTable({
        ...
        ajax: {
            url: "/RptOperation/GetAllPVehicleWiseInfo/",
            type: 'POST',
            data: function (d) {
                d.Status = TSId;
                d.FromDate = FDate;
        ...
        columns: [
            ...
            { data: "FilledPerc", sortable: true },
            { data: "WasteType", sortable: true }
        ]
    });
...
function DownloadFile(FType) {
    ...
    var TName = "Primary Vehicle Wise Report From Date-" + FDate + " To Date-" + TDate;

    ShowLoading($('#example'));
    $.ajax({
        type: "POST",
        url: "/RptOperation/ExportPVehicleWiseData",
        data: { Status: TSId, FromDate: FDate, ToDate: TDate, FName: TName, OwnerType: Ownertype},
        xhrFields: {
...
function CSVData(FType) {
    ...
    $.ajax({
        url: '/RptOperation/ExportPVehicleWiseCSV', // URL of your controller action
        method: 'POST',
        data: { Status: TSId, FromDate: FDate, ToDate: TDate, FName: TName, OwnerType: Ownertype },
