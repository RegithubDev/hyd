...
function GetDataTableData(Type) {
    ...
    dt3 = $('#example').DataTable({
        ...
        ajax: {
            url: "/RptOperation/GetAllHKLWisePerformance_Paging/",
            type: 'POST',
            data: function (d) {
                d.ToDate = ToDate;
                d.FromDate = FromDate;
...
function DownloadFile(FType) {
    ...
    var TName = "Hookloader Wise Perfomance Report From Date-" + FromDate + " To Date-" + ToDate;

    ShowLoading($('#dvContent'));
    $.ajax({
        type: "POST",
        url: "/RptOperation/ExportHKLWisePerfSummaryData",
...
function CSVData(FType) {
    ...
    var TName = "Hookloader Wise Perfomance Report From Date-" + FromDate + " To Date-" + ToDate;
    $.ajax({
        url: '/RptOperation/ExportHKLWisePerfSummaryCSV', // URL of your controller action
        method: 'POST',
        data: { FromDate: FromDate, ToDate: ToDate, FName: TName },
