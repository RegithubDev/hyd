$(document).ready(function () {
    ...
    //    var headerRow = $(table).find('thead th').map(function () {
    //        return {
    //            v: $(this).text(),
    //            s: {
    //                font: { bold: true },
    ...
    //    var blob = XLSX.write(wb, { bookType: 'blob', mimeType: 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet' });
    ...
    //});
     ...
     $("#btnExcel").click(function () {
            ...
            // Add the table header row to the data
            var headers = [];
...
function SetDataBind(Type) {
    ...
    $.ajax({
        type: "POST",
        url: '/Demo/GetVehicleMasterSummary',
        dataType: "json",
