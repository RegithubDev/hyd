...
function GetDataTableData(Type) {
    ...
    dt = $('#example').DataTable({
        ...
        ajax: {
            url: "/Operation/RptGetAllVehiclesDetailsInfo/",
        ...
        columns: [
            ...
            { data: "TotalCount", sortable: true },
            { data: "TotalArrivalCount", sortable: true },
            { data: "TotalTripCount", sortable: true },
            //{ data: "VehicleType", sortable: true },
...
function DownloadFile(FType) {
    ...
    var TName = "Vehicle Wise Collection";

    ShowLoading($('#dvNotification'));
    $.ajax({
        type: "POST",
        url: "/Operation/ExportGetAllVehicleDetail",
        data: { FromDate: FDate, ToDate: TDate, Status: TSId, FName: TName },
        xhrFields: {
