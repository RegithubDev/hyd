...
function GetDataTableData(Type) {
    ...
    dt = $('#example').DataTable({
        ...
        ajax: {
            url: "/Operation/RptOperationSummaryInfo/",
...
function DownloadFile(FType) {
    ...
    $.ajax({
        type: "POST",
        url: "/Operation/ExportOperationSummaryData",
...
function CSVData(FType) {
    ...
    var TName = "Operation Summary";
    $.ajax({
        url: '/Operation/ExportOperationSummaryCSV', // URL of your controller action
        method: 'POST',
        data: { zid: zid, cid: cid, VehicleTypeId: VId, TSId: TSId, FromDate: FDate, ToDate: TDate, FName: TName },
